...
extern int sys_command_cd_play4 (int unitnum, int startlsn, int endlsn, int);
...
extern int sys_command_cd_rawread5 (int unitnum, uae_u8 *data, int sector, int size, int sectorsize);
