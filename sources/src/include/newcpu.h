...
#define REGSGEN _Generic((regs), struct regstruct *: (regs), default: &(regs))
#define op_illg(op) _op_illg(op, REGSGEN)
...
#define set_special(x) _set_special(REGSGEN, x)
...
#define unset_special(x) _unset_special(REGSGEN, x)
...
#define m68k_setpc(newpc) _m68k_setpc(REGSGEN, newpc)
...
#define m68k_getpc() _m68k_getpc(REGSGEN)
...
#define m68k_do_rts() _m68k_do_rts(REGSGEN)
...
#define x_next_iword() next_iword(REGSGEN)
#define x_next_ilong() next_ilong(REGSGEN)

extern void m68k_setstopped (void);
extern void m68k_resumestopped (void);

#define x_get_disp_ea_020(base,dp) _get_disp_ea_020(REGSGEN, base, dp)
...
#define Exception(nr) _Exception(nr, REGSGEN)
...
extern void exception3z (uae_u32 opcode, uaecptr addr, int w, int i, uaecptr pc);
